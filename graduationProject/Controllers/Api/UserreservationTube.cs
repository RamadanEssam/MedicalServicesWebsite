...
namespace graduationProject.Controllers.Api
{
    ...
    public class UserreservationTube : ControllerBase
    {
        private readonly InterfaceRepository<UserReservationOxegin> _userReserveRepository;

        public UserreservationTube(InterfaceRepository<UserReservationOxegin> UserReserveRepository)
        {
